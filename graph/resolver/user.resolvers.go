...
func (r *mutationResolver) DeleteUser(ctx context.Context, id int64) (bool, error) {
	userCtx := auth.GetUser(ctx)
	if !r.PermissionChecker.CanAdmin(userCtx.SubjectPermissions, model.AdminSectionUsers, model.ActionDelete) {
...
func (r *userResolver) Permissions(ctx context.Context, obj *model.User) (*model.SubjectPermissions, error) {
...
func (r *userResolver) Roles(ctx context.Context, obj *model.User) ([]*string, error) {
	...
	roles, err := r.RoleService.GetUserRolesByType(ctx, obj.ID, model.RoleTypeRole)
	if err != nil {
		return nil, err
	}
