...
-- reverse: modify "redirects" table
ALTER TABLE `redirects` ADD INDEX `idx_redirects_namespace_project` (`namespace_code`, `project_code`);
-- reverse: modify "pages" table
ALTER TABLE `pages` DROP INDEX `idx_pages_namespace_project`;
-- reverse: modify "pages" table
ALTER TABLE `pages` ADD INDEX `idx_pages_namespace_project` (`namespace_code`, `project_code`);
