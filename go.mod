module github.com/flectolab/flecto-manager
...
require (
	...
	github.com/flectolab/flecto-manager/common v0.0.0-00010101000000-000000000000
...
replace github.com/flectolab/flecto-manager/common => ./common
