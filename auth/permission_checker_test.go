...
func TestPermissionChecker_CanResource(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			permissions: &model.SubjectPermissions{
				Resources: []model.ResourcePermission{
					{Namespace: "*", Project: "*", Action: model.ActionAll},
				},
			},
			namespace: "any-ns",
			project:   "any-proj",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := checker.CanResource(tt.permissions, tt.namespace, tt.project, tt.action)
...
func TestPermissionChecker_CanResourceForUsername(t *testing.T) {
	t.Run("success - permission granted", func(t *testing.T) {
		...
		result, err := checker.CanResourceForUsername(ctx, "testuser", "ns1", "proj1", model.ActionRead)
	...
	t.Run("success - permission denied", func(t *testing.T) {
		...
		result, err := checker.CanResourceForUsername(ctx, "testuser", "ns2", "proj1", model.ActionRead)
...
func TestPermissionChecker_CanResourceForRoleCode(t *testing.T) {
	t.Run("success - permission granted", func(t *testing.T) {
		...
		result, err := checker.CanResourceForRoleCode(ctx, "admin", "any-ns", "any-proj", model.ActionDelete)
	...
	t.Run("success - permission denied", func(t *testing.T) {
		...
		result, err := checker.CanResourceForRoleCode(ctx, "reader", "ns1", "proj1", model.ActionWrite)
	...
	t.Run("error from service", func(t *testing.T) {
		...
		result, err := checker.CanResourceForRoleCode(ctx, "unknown", "ns1", "proj1", model.ActionRead)
...
func TestPermissionChecker_CanAdminForRoleCode(t *testing.T) {
	t.Run("success - permission granted", func(t *testing.T) {
		...
		result, err := checker.CanAdminForRoleCode(ctx, "superadmin", model.AdminSectionNamespaces, model.ActionDelete)
...
func TestPermissionChecker_MustCanResourceForUsername(t *testing.T) {
	t.Run("returns true when permission granted", func(t *testing.T) {
		...
		result := checker.MustCanResourceForUsername(ctx, "testuser", "ns1", "proj1", model.ActionRead)
	...
	t.Run("returns false on error", func(t *testing.T) {
		...
		result := checker.MustCanResourceForUsername(ctx, "unknown", "ns1", "proj1", model.ActionRead)
...
func TestPermissionChecker_MustCanResourceForRoleCode(t *testing.T) {
	t.Run("returns true when permission granted", func(t *testing.T) {
		...
		result := checker.MustCanResourceForRoleCode(ctx, "admin", "any-ns", "any-proj", model.ActionDelete)
	...
	t.Run("returns false on error", func(t *testing.T) {
		...
		result := checker.MustCanResourceForRoleCode(ctx, "unknown", "ns1", "proj1", model.ActionRead)
...
func TestPermissionChecker_MustCanAdminForRoleCode(t *testing.T) {
	t.Run("returns true when permission granted", func(t *testing.T) {
		...
		result := checker.MustCanAdminForRoleCode(ctx, "superadmin", model.AdminSectionNamespaces, model.ActionDelete)
