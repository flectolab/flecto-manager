...
func TestResourcePermissionRepository_FindByRoleIDs(t *testing.T) {
	...
	_ = repo.Create(ctx, &model.ResourcePermission{RoleID: role3.ID, Namespace: "ns3", Action: model.ActionDelete})
...
func TestResourcePermissionRepository_FindByNamespaceAndProject(t *testing.T) {
	...
	// Wildcard project
	_ = repo.Create(ctx, &model.ResourcePermission{RoleID: role.ID, Namespace: "prod", Project: "*", Action: model.ActionDelete})
...
func TestAdminPermissionRepository_FindByRoleIDs(t *testing.T) {
	...
	_ = repo.Create(ctx, &model.AdminPermission{RoleID: role3.ID, Section: model.AdminSectionProjects, Action: model.ActionDelete})
