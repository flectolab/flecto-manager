...
mockgen -destination=mocks/flecto-manager/repository/mock.go -package=mockFlectoRepository github.com/flectolab/flecto-manager/repository NamespaceRepository,ProjectRepository,UserRepository,RoleRepository,ResourcePermissionRepository,AdminPermissionRepository,RedirectRepository,RedirectDraftRepository,PageRepository,PageDraftRepository,AgentRepository,TokenRepository,ActivityEventRepository

mockgen -destination=mocks/flecto-manager/service/mock.go -package=mockFlectoService github.com/flectolab/flecto-manager/service RoleService,AuthService,TokenService,UserService,ProjectService,RedirectService,RedirectDraftService,PageService,PageDraftService,AgentService,ActivityService
