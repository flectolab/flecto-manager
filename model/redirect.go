...
type Redirect struct {
	...
	NamespaceCode string   `json:"-" gorm:"size:255;index:idx_redirects_namespace_project"`
	ProjectCode   string   `json:"-" gorm:"size:255;index:idx_redirects_namespace_project"`
...
type RedirectDraft struct {
	ID            int64                 `json:"id" gorm:"primaryKey;autoIncrement"`
	NamespaceCode string                `json:"-" gorm:"size:255;index:idx_redirect_drafts_namespace_project"`
	ProjectCode   string                `json:"-" gorm:"size:255;index:idx_redirect_drafts_namespace_project"`
	Project       *Project              `json:"project" gorm:"foreignKey:NamespaceCode,ProjectCode;references:NamespaceCode,ProjectCode;-:migration"`
	...
	OldRedirect   *Redirect             `json:"oldRedirect" gorm:"foreignKey:OldRedirectID;references:ID;constraint:OnDelete:CASCADE;"`
