...
export function Pages() {
  ...
  const canRead = namespaceCode && projectCode ? canResource(namespaceCode, projectCode, Action.Read) : false
  const canWrite = namespaceCode && projectCode ? canResource(namespaceCode, projectCode, Action.Write) : false
